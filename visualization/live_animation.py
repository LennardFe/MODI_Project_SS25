...
from target_selection.calculations.bearing_calc import get_rotation_matrix
...
class LiveThetaAnimation:
    def __init__(self, db_path="assets/MODI.db", calibration_anchor="5C19"):
        ...
        self.initial_position = get_initial_position(self.database_name)
        self.running = False
    ...
    def get_latest_theta(self):
        ...
        try:
            ...
            theta = get_theta(self.database_name)
